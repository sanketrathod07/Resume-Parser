...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Resume Parser saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Resume Parser apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Resume Parser, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Resume Parser
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Resume Parser is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Resume Parser intentionally only offers
  ...
  {
    question: "Q3. Who created Resume Parser and why?",
    answer: (
      <p>
        Resume Parser was created by{" "}
        ...
        that led to Resume Parser, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Resume Parser can help
  ...
  {
    question: "Q4. How can I support Resume Parser?",
    answer: (
      <>
        <p>
          The best way to support Resume Parser is to share your thoughts and
        ...
        <p>
          Another great way to support Resume Parser is by spreading the words.
